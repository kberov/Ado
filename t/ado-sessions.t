...
isa_ok my $f = Ado::Sessions::getInstance('file'), 'Ado::Sessions::File';
isa_ok my $d = Ado::Sessions::getInstance('db'),   'Ado::Sessions::Db';
isa_ok my $m = Ado::Sessions::getInstance('mojo'), 'Mojolicious::Sessions';
