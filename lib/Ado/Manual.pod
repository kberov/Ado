...
L<Ado> goes together with the following:
...
=item * L<Ado::Command::generate::apache2vhost> 
generates a minimal Apache2 Virtual Host configuration file for your L<Ado>
application.

=item * L<Ado::Command::generate::apache2htaccess> 
...
=item * L<Ado::Plugin::I18n> localizes your application and site.
...
you may want to add the C</path/to/ado/bin> to your C<$PATH> environment variable.
