...
recommendations found in L<Mojolicious::Guides>. When in doubt how 
...
L<DBIx::Simple::Class> was developed in fact for Ado as a simple OM that 
provides representation of table records as plain Perl objects.
Ado is the successor of L<MYDLjE|https://github.com/kberov/MYDLjE>.
...
or installed directly from CPAN using C<cpan> or C<cpanm> commandline tools.
...
perldoc command. To use C<perldoc> for reading documentation you need to add 
