...
Ado is a typical L<Mojo> application. It has default 
...
Ado has additional L<plugins|Ado::Plugin> and L<commands|Ado::Command>, 
which are good to have when starting new projects, based on Mojolicious.
L<Semantic UI|http://semantic-ui.com/> is included in the distribution
