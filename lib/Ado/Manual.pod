...
=item To learn about plugins and how to write your own plugin, see Ado::Manual::Plugins.

=item * Start a personal blog in L<Ado::Manual::FiveMinutes>.
...
common base trough L<Ado::Plugin> which ISA L<Mojolicious::Plugins>. Ado plugins
