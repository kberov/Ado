...
=item * Create one or more tables to be used by your plugin in etc/ado.sqlite
...
which can even be uploaded to and subsequently downloaded from L
<CPAN|http://www.cpan.org/>. L<CPAN> is the best open source dependency
