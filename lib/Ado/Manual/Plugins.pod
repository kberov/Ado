...
The following plugins are known to exist. You can install and use them in
your application.

=over 2

=item * Ado::Plugin::Vest - Messaging services for an Ado system!

=item * Ado::Plugin::Admin - system (site) administration user interface
