...
your code must be passed through perltidy using the C<t/.perltidyrc>
...
to C<t/.perltidyrc>. Be ready to explain well your proposal.
...
Generate your classes from tables using L<dsc_dump_schema.pl> utility.
